...
const style={
	...
	navItem:`px-4 py-2 m-1 flex items-center text-lg font-semibold text-semibold text-[0.9rem] cursor-pointer rounded-3xl`,
	activeNavItem:`bg-[#20242A]`,
	buttonContainer:`flex w-1/4 justify-end items-center`,
	...
	const {connectWallet,currentAccount}=useContext(TransactionContext)
	 return (
	  <div className={style.wrapper}>
		 ...
		 {currentAccount ?  
			 (<div className={`${style.button} ${style.buttonPadding}`}> {`${currentAccount.slice(0,3)}...${currentAccount.slice(12,16)}`} </div> )
			 :
			 ( 
